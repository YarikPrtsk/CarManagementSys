...
public class CancelCarSaleCommandHandler : IRequestHandler<CancelCarSaleCommand, Result>
{
    private readonly ICarSaleRepository _repository;

    public CancelCarSaleCommandHandler(ICarSaleRepository repository)
    {
        _repository = repository;
    }

    public async Task<Result> Handle(CancelCarSaleCommand request, CancellationToken cancellationToken)
    {
