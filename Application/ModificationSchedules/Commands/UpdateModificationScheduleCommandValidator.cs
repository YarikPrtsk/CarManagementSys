...
public class UpdateModificationScheduleCommandValidator : AbstractValidator<UpdateModificationScheduleCommand>
{
    public UpdateModificationScheduleCommandValidator()
    {
        RuleFor(x => x.Id)
